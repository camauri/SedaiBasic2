...
180 PRINT "A * B = "; A * B
190 PRINT "A / B = "; A / B
200 PRINT "A ^ B (POWER) = "; A ^ B
210 PRINT "A MOD B = "; A MOD B
220 PRINT "------------------------------": PRINT
230 GOSUB 9000
...
590 PRINT "F OR F = "; F OR F
600 PRINT "NOT T = "; NOT T
610 PRINT "NOT F = "; NOT F
620 PRINT "T XOR F = "; T XOR F
630 PRINT "T XOR T = "; T XOR T
640 PRINT "------------------------------": PRINT
650 GOSUB 9000
...
770 IF N = 42 THEN PRINT "N EQUALS 42" ELSE PRINT "N DOES NOT EQUAL 42"
780 PRINT "------------------------------": PRINT
790 GOSUB 9000
...
850 GOTO 860
855 PRINT "THIS LINE SHOULD BE SKIPPED"
...
1070 GOTO 1110
1080 PRINT "C = 1": GOTO 1110
1090 PRINT "C = 2 (CORRECT!)": GOTO 1110
1100 PRINT "C = 3": GOTO 1110
...
2260 DEF FNDB(X) = X * 2
2270 PRINT "FNSQ(5) = "; FNSQ(5)
2280 PRINT "FNCU(3) = "; FNCU(3)
2290 PRINT "FNDB(7) = "; FNDB(7)
2300 PRINT "------------------------------": PRINT
2310 GOSUB 9000
...
2660 PRINT "AR(5) = "; AR(5)
2670 AR2(2, 3) = 123
2680 PRINT "AR2(2,3) = "; AR2(2, 3)
2690 AR3(1, 2, 3) = 456
2700 PRINT "AR3(1,2,3) = "; AR3(1, 2, 3)
2710 PRINT "------------------------------": PRINT
2720 GOSUB 9000
...
3050 PRINT "S$ = "; S$
3060 PRINT "LEN(S$) = "; LEN(S$)
3070 PRINT "LEFT$(S$,5) = "; LEFT$(S$, 5)
3080 PRINT "RIGHT$(S$,5) = "; RIGHT$(S$, 5)
3090 PRINT "MID$(S$,3,5) = "; MID$(S$, 3, 5)
3100 PRINT "ASC(";CHR$(34);"A";CHR$(34);") = "; ASC("A")
3110 PRINT "CHR$(65) = "; CHR$(65)
3120 PRINT "STR$(123) = "; STR$(123)
3130 PRINT "VAL(";CHR$(34);"456";CHR$(34);") = "; VAL("456")
3140 PRINT "INSTR(S$,";CHR$(34);"WORLD";CHR$(34);") = "; INSTR(S$, "WORLD")
3150 PRINT "INSTR(1,S$,";CHR$(34);"O";CHR$(34);") = "; INSTR(1, S$, "O")
3160 PRINT "HEX$(255) = "; HEX$(255)
3170 PRINT "DEC(";CHR$(34);"FF";CHR$(34);") = "; DEC("FF")
3180 PRINT "------------------------------": PRINT
3190 GOSUB 9000
...
3340 PRINT "ABS(-5) = "; ABS(-5)
3350 PRINT "SGN(-5) = "; SGN(-5)
3360 PRINT "SGN(0) = "; SGN(0)
3370 PRINT "SGN(5) = "; SGN(5)
3380 PRINT "INT(3.7) = "; INT(3.7)
3390 PRINT "INT(-3.7) = "; INT(-3.7)
3400 PRINT "SQR(16) = "; SQR(16)
3410 PRINT "SIN(0) = "; SIN(0)
3420 PRINT "COS(0) = "; COS(0)
3430 PRINT "TAN(0) = "; TAN(0)
3440 PRINT "ATN(1) = "; ATN(1)
3450 PRINT "EXP(1) = "; EXP(1)
3460 PRINT "LOG(2.718) = "; LOG(2.718)
3470 PRINT "LOG10(100) = "; LOG10(100)
3480 PRINT "LOG2(8) = "; LOG2(8)
3490 PRINT "RND(0) = "; RND(0)
3500 PRINT "------------------------------": PRINT
3510 GOSUB 9000
...
4060 PRINT "ATTEMPTING DIVISION BY ZERO..."
4070 LET Z = 1 / 0
4080 PRINT "THIS SHOULD NOT PRINT"
4090 GOTO 4200
4100 REM ERROR HANDLER
...
4150 TRAP 0
4160 RESUME NEXT
4200 PRINT "CONTINUING AFTER ERROR..."
4210 PRINT "------------------------------": PRINT
4220 GOSUB 9000
...
7000 REM ========================================
7010 REM *** TEST COMPLETE ***
7020 REM ========================================
7030 PRINT
7040 PRINT "=============================================="
7050 PRINT "         ALL TESTS COMPLETED!"
7060 PRINT "=============================================="
7070 PRINT
7080 PRINT "SEDAIBASIC FULL FEATURE TEST FINISHED"
7090 PRINT
7100 END
