...
30 REM  80x50 text mode with FRAME sync
...
310 TOPWALL = 2     : REM Top boundary row
320 BOTWALL = 48    : REM Bottom boundary row
...
400 REM === GAME STATE ===
410 P1Y = 22       : REM Player paddle Y
420 P2Y = 22       : REM CPU paddle Y
...
470 P1SCORE = 0    : REM Player score
480 P2SCORE = 0    : REM CPU score
490 GAMEOVER = 0
...
1000 REM =============================================
1010 REM  MAIN GAME LOOP (FRAME-synced at 30 FPS)
1020 REM =============================================
...
1210 IF K$ = "" THEN GOTO 1350
1220 K = ASC(K$)
1230 IF K$ = "W" OR K$ = "w" OR K = 1 THEN IF P1Y > TOPWALL THEN P1Y = P1Y - 1
1240 IF K$ = "S" OR K$ = "s" OR K = 2 THEN IF P1Y < BOTWALL - PADDLEH THEN P1Y = P1Y + 1
1250 IF K$ = "Q" OR K$ = "q" THEN GAMEOVER = 1: GOTO 3000

1350 REM === MOVE CPU PADDLE (Simple AI) ===
1360 REM CPU follows ball with slight delay
...
1600 REM === CHECK TOP/BOTTOM WALL BOUNCE ===
1610 IF NEWBY <= TOPWALL THEN BDY = 1: NEWBY = TOPWALL
1620 IF NEWBY >= BOTWALL THEN BDY = -1: NEWBY = BOTWALL

1700 REM === CHECK PLAYER PADDLE COLLISION ===
1710 IF NEWBX <= PADDLEX1 + 1 THEN BEGIN
1720   IF NEWBY >= P1Y AND NEWBY <= P1Y + PADDLEH THEN BEGIN
1730     BDX = 1
1740     NEWBX = PADDLEX1 + 2
1750     IF NEWBY < P1Y + PADDLEH / 2 THEN BDY = -1
1760     IF NEWBY > P1Y + PADDLEH / 2 THEN BDY = 1
1770   BEND
1780 BEND

1800 REM === CHECK CPU PADDLE COLLISION ===
1810 IF NEWBX >= PADDLEX2 - 1 THEN BEGIN
1820   IF NEWBY >= P2Y AND NEWBY <= P2Y + PADDLEH THEN BEGIN
1830     BDX = -1
1840     NEWBX = PADDLEX2 - 2
...
4080 CHAR 0, 50, 0, "0"
4090 REM Top border (row 1)
4100 FOR X = 0 TO 79
4110 CHAR 0, X, 1, "="
4120 NEXT X
4130 REM Bottom border (row 49)
4140 FOR X = 0 TO 79
4150 CHAR 0, X, 49, "="
4160 NEXT X
