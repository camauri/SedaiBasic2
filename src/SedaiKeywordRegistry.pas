...
begin
 ...
 // === LOGICAL OPERATORS ===
 RegisterKeyword(kAND, ttLogicalAND, 'AND operator', kcLogicalOperators);
 RegisterKeyword(kNOT, ttLogicalNOT, 'NOT operator', kcLogicalOperators);
 RegisterKeyword(kOR,  ttLogicalOR,  'OR operator',  kcLogicalOperators);
 RegisterKeyword(kXOR, ttLogicalXOR, 'XOR operator', kcLogicalOperators);
 // Operatori avanzati (opzionali)
 //RegisterKeyword('NAND', ttLogicalNAND, 'NAND operator', kcLogicalOperators);
 //RegisterKeyword('NOR',  ttLogicalNOR,  'NOR operator',  kcLogicalOperators);
 //RegisterKeyword('XNOR', ttLogicalXNOR, 'XNOR operator', kcLogicalOperators);
