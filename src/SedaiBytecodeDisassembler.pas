...
begin
  ...
  case Instr.OpCode of
    ...
    bcThreadSelf:
      Line := Format('%4d: %-20s R%d = self', [Index, 'ThreadSelf', Instr.Dest]);
    bcThreadDetach:
      Line := Format('%4d: %-20s R%d', [Index, 'ThreadDetach', Instr.Src1]);
    bcMutexCreate:
    ...
    bcStrInstrAnyW:
      Line := Format('%4d: %-20s R%d, R%d, R%d', [Index, 'StrInstrAnyW', Instr.Dest, Instr.Src1, Instr.Src2]);
    bcStrInstrRevAnyW:
      Line := Format('%4d: %-20s R%d, R%d, R%d', [Index, 'StrInstrRevAnyW', Instr.Dest, Instr.Src1, Instr.Src2]);
    bcStrWChr:
    ...
    bcLoadERFN:
      Line := Format('%4d: %-20s R%d', [Index, 'LoadERFN', Instr.Dest]);
    bcLoadERMN:
      Line := Format('%4d: %-20s R%d', [Index, 'LoadERMN', Instr.Dest]);
    bcWInputChars:
