...
const
  ...
  OPCODES: array[0..OPCODE_LIST_COUNT - 1] of Word = (
    ...
    bcArrayCopyRecords, bcArrayBindInd, bcRawLoadZStr, bcRawStoreZStr, bcArrayDescPtr, bcArrayDescPtrInd, bcArrayElemAddr, bcPrint, bcPrintLn, bcPrintString, bcPrintStringLn,
  ...
  DENSE_ARRAY_SIZE    = 55;   // group 3   (bcArrayDescPtr/Ind = subs 52/53, bcArrayElemAddr = 54)
