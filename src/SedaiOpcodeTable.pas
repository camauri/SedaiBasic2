...
const
  ...
  OPCODE_LIST_COUNT = 573 {$IFDEF WEB_MODE} + 12 {$ENDIF};   // +1 bcGfxDrawString; +5 bit intrinsics; +5 CEIL..COPYSIGN; +2 the bit-casts; +1 bcCpuCount; +13 BigInt; +1 bcStrMidAssignArr; +1 bcGfxCircleExF; +1 bcRecordReallocBlock; +1 bcRecordBlockLen
  ...
  DENSE_STRING_BASE   = 171;  // group 1  (50)          -> 168..217 (bcStrAscMid = sub 51)
  DENSE_MATH_BASE     = 223;  // group 2  (43)          -> 220..262
  ...
  DENSE_ARRAY_BASE    = 266;  // group 3  (52)          -> 254..305 (bcRawLoad/StoreZStr = subs 50/51)
  DENSE_IO_BASE       = 318;  // group 4  (23)          -> 306..328
  ...
  DENSE_SPECIAL_BASE  = 341;  // group 5  (18)          -> 338..355
  DENSE_FILEIO_BASE   = 359;  // group 6  (37)
  DENSE_SPRITE_BASE   = 396;  // group 7  (17)
  {$IFDEF WEB_MODE}
  // group 8 (web, subs 1..12) inserts a 13-slot block, shifting graphics/sound/super up by 13.
  DENSE_WEB_BASE      = 412;  // 12 used, slot 0 a hole
  ...
  DENSE_GRAPHICS_BASE = 426;  // group 10 (69)
  DENSE_SOUND_BASE    = 495;  // group 11 (6)
  ...
  DENSE_BIGINT_BASE   = 501;  // group 12 (13)
  DENSE_SUPER_BASE    = 514;  // group 200 (72 slots: DENSE 0..71)
  DENSE_TOTAL         = 586;  // N (with web)
  {$ELSE}
  DENSE_GRAPHICS_BASE = 413;  // group 10 (69)
  DENSE_SOUND_BASE    = 482;  // group 11 (6)
  DENSE_BIGINT_BASE   = 488;  // group 12 (13)
  DENSE_SUPER_BASE    = 501;  // group 200 (72 slots, no holes: DENSE 0..71)
  DENSE_TOTAL         = 573;  // N
  {$ENDIF}
