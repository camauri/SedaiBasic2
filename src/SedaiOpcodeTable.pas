...
const
  ...
  OPCODES: array[0..OPCODE_LIST_COUNT - 1] of Word = (
    ...
    bcStrInstrAnyW, bcStrInstrRevAnyW, bcUtfConv,
    ...
    bcArrayCopyRecords, bcArrayBindInd, bcRawLoadZStr, bcRawStoreZStr, bcArrayDescPtr, bcArrayDescPtrInd, bcArrayElemAddr, bcArrayLoadNarrow, bcArrayStoreNarrow, bcArrayLoadSingle, bcArrayStoreSingle, bcPtrFromInt, bcPrint, bcPrintLn, bcPrintString, bcPrintStringLn,
