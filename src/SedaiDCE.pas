...
begin
  ...
  case Instr.OpCode of
    ...
    ssaDopen, ssaOpenFunc, ssaDirSearch, ssaVarArgCtl, ssaVarArgPushInt, ssaVarArgPushFloat, ssaVarArgPushStr, ssaDclose, ssaOpen, ssaClose,
    ...
    // Console cursor / print area - move state the next PRINT depends on
    ssaConLocate,     // MODERN LOCATE row, col
    ssaConViewPrint,  // VIEW PRINT first TO last
    ...
    ssaGfxScreenRes, ssaGfxPset, ssaGfxPaint, ssaGfxPaintBorder, ssaGfxSetTarget, ssaGfxLine, ssaGfxLineStyled, ssaGfxCircle, ssaGfxCircleEx, ssaGfxDrawGML, ssaGfxDrawString,
