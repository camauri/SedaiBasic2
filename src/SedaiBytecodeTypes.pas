...
const
  ...
  // Logical operations
  bcLogicalAnd      = bcGroupCore + 42;
  bcLogicalOr       = bcGroupCore + 43;
  bcLogicalXor      = bcGroupCore + 44;
  bcLogicalNot      = bcGroupCore + 45;
  // Control flow
  ...
  case Group of
    0: // Core VM
      case SubOp of
        ...
        42: Result := 'LogicalAnd';
        43: Result := 'LogicalOr';
        44: Result := 'LogicalXor';
        45: Result := 'LogicalNot';
        46: Result := 'Jump';
