...
begin
  ...
  Context.SetParseRule(ttLogicalNOT, MakePrefixRule(@StaticParseLogicalNot, precUnary));
  ...
  // Logical operators
  Context.SetParseRule(ttLogicalAND, MakeInfixRule(@StaticParseBinaryOperator, precAnd));
  Context.SetParseRule(ttLogicalOR, MakeInfixRule(@StaticParseBinaryOperator, precOr));
  Context.SetParseRule(ttLogicalXOR, MakeInfixRule(@StaticParseBinaryOperator, precOr));
...
begin
  ...
  Result := CreateUnaryOpNode(ttLogicalNOT, Operand, Token);
  DoNodeCreated(Result);
end;
